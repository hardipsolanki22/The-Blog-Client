...
//   return !isLoading ? (
//     <div className={`h-auto sm:max-h-[83.7vh] lg:[86.7vh] xl:max-h-[83.7vh]  
//      sm:overflow-y-auto sm:no-scrollbar ${themeMode ? 'dark' : 'light'} sm:border-none border-b border-slate-600`}>
//       {posts?.pages.map((page) => (
//         page.data?.map((post) => (<div key={post._id}
//           className='flex flex-col justify-center border-t border-slate-600  p-5 h-auto'>
//           <PostCart {...post} />
//         </div>
//         ))
...
//       ))}
//       <div ref={ref}
//         className='flex justify-center items-center mb-24 mt-4 sm:my-4 '>
//         {/* {isFetchingNextPage ? */}
//           <Oval
//             height={'40'}
//             width={'40'}
